...
const ServiceCard = (props) => {
	return (
		<div className="box w-full serviceCards flex flex-col 2xl:gap-y-8 xl:gap-y-8 lg:gap-y-8 md:gap-y-8 sm:gap-y-4 gap-y-1 items-center 2xl:p-10 xl:p-10 lg:p-10 md:p-10 sm:p-5 p-3 rounded-xl h-full">
			<div className="symbol w-fit h-full bg-[#3b3439] p-4 rounded-full">
		...
		<div className="container mx-auto bg-transparent z-20">
			<div className="grid 2xl:grid-cols-12 xl:grid-cols-12 lg:grid-cols-12 md:grid-cols-2 sm:grid-cols-2 grid-cols-2">
				<div className="col-span-7">
					<div className="2xl:text-7xl xl:text-6xl lg:text-5xl md:text-4xl sm:text-4xl text-base 2xl:text-left xl:text-left lg:text-left md:text-center sm:text-center text-center font-Cabinet font-bold 2xl:px-0 xl:px-0 lg:px-0 md:px-10 sm:px-5 px-5">
				...
				<div className="col-span-5 flex items-center 2xl:justify-end xl:justify-end lg:justify-end md:justify-center sm:justify-center justify-center">
					<div className="2xl:text-base xl:text-base lg:text-base md:text-base sm:text-base text-[12px] font-Cabinet text-[#cb492b] font-bold underline">
						Learn More
					</div>
				</div>
			</div>

			<div className="grid 2xl:grid-cols-12 xl:grid-cols-12 lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-2 grid-cols-2 2xl:gap-x-16 xl:gap-x-10 lg:gap-x-5 md:gap-x-8 sm:gap-x-0 gap-x-0 2xl:gap-y-0 xl:gap-y-0 lg:gap-y-0 md:gap-y-8 sm:gap-y-5 gap-y-5 pt-[89px] 2xl:px-0 xl:px-0 lg:px-0 md:px-10 sm:px-10 px-5">
